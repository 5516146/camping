...
DROP SEQUENCE seq_BOARD_NOTICE;
...
CREATE TABLE "BOARD_REVIEW" (
	...
	"BOARD_HIT"	NUMBER(10)	DEFAULT 5	NOT NULL,
...
ALTER TABLE "BOARD_FREE" ADD CONSTRAINT "FK_MEMBER_TO_BOARD_FREE_1" FOREIGN KEY (
	"MEM_ID"
)
REFERENCES "MEMBER" (
	"MEM_ID"
...
CREATE SEQUENCE seq_BOARD_FREE
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
...
commit ;
--테스트용
-- INSERT INTO BOARD_REVIEW VALUES (SEQ_BOARD_REVIEW.NEXTVAL, '임시 테스트', '테스트 내용', SYSDATE, SYSDATE, 3, 'user11');
-- INSERT INTO BOARD_REVIEW VALUES (SEQ_BOARD_REVIEW.NEXTVAL, '테스트 테스트 테스트', '테스트 내용', SYSDATE, SYSDATE, 5, 'user11');
--
-- select * from board_review;
--
-- update MEMBER_AUTH set AUTH = 'ROLE_ADMIN' where MEM_ID = 'admin1';
--
-- select * from member;
