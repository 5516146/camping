...
public class UploadController {
	...
	@ResponseBody
	public ResponseEntity<List<Notice_AttachVO>> uploadAjaxPost(MultipartFile[] uploadFile) {

		List<Notice_AttachVO> list = new ArrayList<>();
		String uploadFolder = "C:\\upload";
		...
		for (MultipartFile multipartFile : uploadFile) {
			...
			Notice_AttachVO attachDTO = new Notice_AttachVO();
			...
			log.info("only file name: " + uploadFileName);
			attachDTO.setAttach_name(uploadFileName);
			...
			try {
				...
				attachDTO.setAttach_uuid(uuid.toString());
				attachDTO.setAttach_path(uploadFolderPath);

				// check image type file
				if (checkImageType(saveFile)) {

					attachDTO.setAttach_Type(true);
