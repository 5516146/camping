...
<section id="about" class="about">
    <div class="container">
        <div class="section-title">
            ...
            <br/>
            <br/>
            <h3 class="font-h3">카라반 F1호</h3>
              <img src="/resources/assets/img/카라반.jpeg" class="img-fluid resized-img" alt="..." onclick="openModal('modal16', '/resources/assets/img/카라반.jpeg')">
             <br/>
            <br/>
            <h3 class="font-h3">카라반 F2호</h3>
              <img src="/resources/assets/img/카라반(2).jpeg" class="img-fluid resized-img" alt="..." onclick="openModal('modal17', '/resources/assets/img/카라반(2).jpeg')">
            <!-- 모달 -->
            <div id="modal16" class="modal">
                <div class="modal-content">
                    <span class="close" onclick="closeModal('modal16')">&times;</span>
                    <img class="img-fluid" id="img16">
                </div>
            </div>
